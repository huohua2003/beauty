<template>
    <div>
        <van-tabbar v-model="active" @change="changTab">
            <van-tabbar-item>
                <van-icon class="iconfont icon-meiyan" slot="icon" />
                <span>美吧</span>
            </van-tabbar-item>

            <van-tabbar-item>
                <van-icon class="iconfont icon-74wodedingdan" slot="icon" />
                <span>购物车</span>
            </van-tabbar-item>

            <van-tabbar-item>
                <van-icon class="iconfont icon-find" slot="icon" />
                <span>发现</span>
            </van-tabbar-item>
